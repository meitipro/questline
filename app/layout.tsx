...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    /* The site's own url. Every route sets its own beside its title, so this
     * is the front door's card and not a default anything else falls back to -
     * a shared /season used to preview as the landing page. */
    url: ORIGIN,
    siteName: "Questline",
    type: "website",
